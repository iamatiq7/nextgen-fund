...
await Store.login('admin', 'nextgen2026');
await Store.register({ fullName: 'Split Case', username: 'adv.split', email: 'adv.split@nextgen.local', phone: '01711777777', nominee: 'Test Nominee', nomineeAddress: 'Test address', joinMonth: U.currentMonth(), shares: 1, password: 'AdvPass1234', docs: tinyDocs.map((d) => Object.assign({}, d)) });
