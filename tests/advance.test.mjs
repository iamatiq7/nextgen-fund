...
await Store.register({ fatherName: 'Father Name', motherName: 'Mother Name', nomineeRelation: 'Brother', fullName: 'Advance Case', username: 'adv.case', email: 'adv.case@nextgen.local', phone: '01711999999', nominee: 'Test Nominee', nomineeAddress: 'Test address', nomineeRelation: 'Brother', fatherName: 'Father Name', motherName: 'Mother Name', joinMonth: U.currentMonth(), shares: 1, password: 'AdvPass1234', docs: tinyDocs.map((d) => Object.assign({}, d)) });
...
await Store.login('admin', 'nextgen2026');
await Store.register({ fatherName: 'Father Name', motherName: 'Mother Name', nomineeRelation: 'Brother', fullName: 'Split Case', username: 'adv.split', email: 'adv.split@nextgen.local', phone: '01711777777', nominee: 'Test Nominee', nomineeAddress: 'Test address', joinMonth: U.currentMonth(), shares: 1, password: 'AdvPass1234', docs: tinyDocs.map((d) => Object.assign({}, d)) });
