...
await Store.register({ fullName: 'Pending Case', username: 'pend.case', email: 'pend.case@nextgen.local', phone: '01711000001', nominee: 'Test Nominee', nomineeAddress: 'Test address', nomineeRelation: 'Brother', fatherName: 'Father Name', motherName: 'Mother Name', joinMonth: U.currentMonth(), shares: 1, password: 'PendPass1234', docs: tinyDocs.map((d) => Object.assign({}, d)) });
